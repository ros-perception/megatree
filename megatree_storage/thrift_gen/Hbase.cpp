...
uint32_t Hbase_getRowOrBefore_result::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.success) {
    ...
    {
      xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->success.size()));
      std::vector<TCell> ::const_iterator _iter331;
...
void HbaseProcessor::process_getRowOrBefore(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (eventHandler_.get() != NULL) {
    ctx = eventHandler_->getContext("Hbase.getRowOrBefore", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(eventHandler_.get(), ctx, "Hbase.getRowOrBefore");

  if (eventHandler_.get() != NULL) {
    eventHandler_->preRead(ctx, "Hbase.getRowOrBefore");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postRead(ctx, "Hbase.getRowOrBefore", bytes);
  }
  ...
  try {
    ...
    if (eventHandler_.get() != NULL) {
      eventHandler_->handlerError(ctx, "Hbase.getRowOrBefore");
    }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->preWrite(ctx, "Hbase.getRowOrBefore");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postWrite(ctx, "Hbase.getRowOrBefore", bytes);
  }
}
...
void HbaseProcessor::process_getRegionInfo(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (eventHandler_.get() != NULL) {
    ctx = eventHandler_->getContext("Hbase.getRegionInfo", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(eventHandler_.get(), ctx, "Hbase.getRegionInfo");

  if (eventHandler_.get() != NULL) {
    eventHandler_->preRead(ctx, "Hbase.getRegionInfo");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postRead(ctx, "Hbase.getRegionInfo", bytes);
  }
  ...
  try {
    ...
    if (eventHandler_.get() != NULL) {
      eventHandler_->handlerError(ctx, "Hbase.getRegionInfo");
    }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->preWrite(ctx, "Hbase.getRegionInfo");
  }
  ...
  if (eventHandler_.get() != NULL) {
    eventHandler_->postWrite(ctx, "Hbase.getRegionInfo", bytes);
  }
}
